...
wav, sr = torchaudio.load(audio_file) # This is where you load your wav, with soundfile or torchaudio for example
...
numpy.savez(semantic_prompt=semantics, fine_prompt=fine_prompt, coarse_prompt=coarse_prompt, file="Voice1.npz")
